...
\end{align*}
Since the graph can contains edges with negative costs, Dijkstra’s Algorithm won’t suffice.
...
As a further improvement, we can skip expanding vertices in the routine, whenever their current distance to the start vertex is already bigger than $3$.
